...
//       st.executeUpdate("insert into appuser(userRole,name,dob,mobileNumber,email,username,password,address) values('Admin','sunil','28-12-2001','9834505584','sunil9834@gmail.com','coe','pass','india')");
